...
var tailwind_default = "/build/_assets/tailwind-GRVFYP2H.css";
...
var sessionUserIdKey = "userId", authSessionStorage = createCookieSessionStorage({
  cookie: {
...
async function getUserId(request) {
  return (await authSessionStorage.getSession(
    request.headers.get("Cookie")
  )).get(sessionUserIdKey);
}
async function getCurrentUser(id) {
  if (!id)
    return null;
  let response = await fetchFromGraphQL(USER_QUERY, {
    id
...
var csrfTokenKey = "CRAFT_CSRF_TOKEN", csrfCookieStorage = createCookieSessionStorage2({
  cookie: {
    name: csrfTokenKey,
    sameSite: "none",
    path: "/",
...
}), originalCommitSession2 = csrfCookieStorage.commitSession;
Object.defineProperty(csrfCookieStorage, "commitSession", {
  value: async function(...args) {
    ...
    let expires = session.has("expires") ? new Date(session.get("expires")) : void 0;
    return await originalCommitSession2(session, {
      ...options,
      expires
    });
  }
...
async function loader({ request }) {
  let csrf = await getCraftCsrfToken(), userId = await getUserId(request), user = await getCurrentUser(userId), session = await csrfCookieStorage.getSession(
    request.headers.get("Cookie")
  );
  return session.set(csrfTokenKey, csrf.csrfTokenValue), json(
    { csrf, userId, user },
    {
      headers: {
...
function App({ userId, user }) {
  return /* @__PURE__ */ jsxDEV4("html", { lang: "en", children: [
    ...
    /* @__PURE__ */ jsxDEV4("body", { children: [
      ...
      /* @__PURE__ */ jsxDEV4(Outlet, { context: { userId, user } }, void 0, !1, {
        fileName: "app/root.tsx",
        lineNumber: 67,
        columnNumber: 5
      }, this),
...
function AppWithProviders() {
  let loaderData = useLoaderData(), { csrf, userId, user } = loaderData;
  return /* @__PURE__ */ jsxDEV4(AuthenticityTokenProvider, { token: csrf.csrfTokenValue, children: /* @__PURE__ */ jsxDEV4(App, { userId, user }, void 0, !1, {
    fileName: "app/root.tsx",
    lineNumber: 86,
    columnNumber: 4
  }, this) }, void 0, !1, {
...
function NavbarUser() {
  let { userId, user } = useOutletContext2();
  return console.log({ user }), /* @__PURE__ */ jsxDEV9("header", { children: /* @__PURE__ */ jsxDEV9("nav", { className: "flex h-[48px] border-b border-opacity-30 border-black fixed top-0 w-full z-30 bg-[#161616]", children: /* @__PURE__ */ jsxDEV9("div", { className: "container mx-auto px-[15px] md:px-0 flex items-center justify-between h-full", children: [
    ...
    /* @__PURE__ */ jsxDEV9("div", { className: "flex items-center", children: [
      /* @__PURE__ */ jsxDEV9("span", { className: "text-[#f4f4f4] text-[14px] mr-[15px]", children: user.fullName }, void 0, !1, {
        fileName: "app/components/navbar-user.tsx",
        lineNumber: 81,
        columnNumber: 7
      }, this),
...
async function action({ request }) {
  ...
  if (data.success) {
    let username = formData.get("loginName"), pw = formData.get("password"), user = await getUserSession({ username, pw }), session = await authSessionStorage.getSession(
      request.headers.get("Cookie")
    );
    return session.set(sessionUserIdKey, user.id), session.set("currentUser", user), redirect2("/my-courses", {
      headers: {
...
function Login() {
  ...
  return /* @__PURE__ */ jsxDEV13(Layout, { children: /* @__PURE__ */ jsxDEV13(Container, { children: /* @__PURE__ */ jsxDEV13("div", { className: "flex items-center justify-center w-full h-full", children: /* @__PURE__ */ jsxDEV13("div", { className: "relative mx-auto sm:w-[500px] md:w-full md:grid justify-center", children: [
    ...
    /* @__PURE__ */ jsxDEV13("div", { className: "bg-white w-full md:w-[480px] p-[30px] shadow-2xl md:col-start-1 md:col-end-[2px] md:row-start-1 md:row-end-1", children: [
      ...
      /* @__PURE__ */ jsxDEV13(Form2, { className: "bg-white w-full", method: "POST", children: [
        /* @__PURE__ */ jsxDEV13(AuthenticityTokenInput, { name: csrfTokenKey }, void 0, !1, {
          fileName: "app/routes/_auth+/login.tsx",
          lineNumber: 89,
          columnNumber: 9
        }, this),
...
async function action3({ request }) {
  let formData = await request.formData(), response = await fetch("http://cdl-training.cs/guest-entries/save", {
    headers: {
      Accept: "application/json"
    },
    method: "POST",
  ...
  return json3(await response.json());
}
function ContactUs() {
  let actionData = useActionData2();
  return console.log({ actionData }), /* @__PURE__ */ jsxDEV16(Layout, { children: /* @__PURE__ */ jsxDEV16("div", { className: "bg-[url('/img/backgrounds/contact.jpg')] bg-cover w-full h-full bg-no-repeat px-[15px] md:px-0 py-[20px] sm:py-[90px] mb-[-50px]", children: /* @__PURE__ */ jsxDEV16("div", { className: "container mx-auto  flex justify-center w-full h-full", children: /* @__PURE__ */ jsxDEV16("div", { className: "w-full md:w-[480px] bg-white py-[30px] z-[10] px-[30px]", children: [
    ...
    /* @__PURE__ */ jsxDEV16(Form3, { method: "POST", children: [
      /* @__PURE__ */ jsxDEV16(AuthenticityTokenInput2, { name: "CRAFT_CSRF_TOKEN" }, void 0, !1, {
        fileName: "app/routes/_single+/contact-us.tsx",
        lineNumber: 56,
        columnNumber: 8
      }, this),
...
var cssActiveLink = (active) => `text-[16px] text-[#161616] text-left py-[18px] relative flex items-center ${active ? "border-b-2 border-[#0F62FE] mb-[-2px] font-medium" : ""}`, loader4 = async ({ request }) => (await requireLogin(request), json4({}));
function MyAccount() {
...
async function loader7({ request }) {
  return await requireLogin(request), json7({});
}
...
async function loader9({ request, params }) {
  ...
  return json9(await response.json());
}
...
function Segment({ entry: entry2 }) {
  ...
  return /* @__PURE__ */ jsxDEV43(Fragment2, { children: [
    " ",
...
var meta11 = ({ data }) => [
  ...
  return json12({ course: course.data.entry });
};
...
async function loader14({ params }) {
  ...
  formData.append("userCourseId", params.userCourse), formData.append("segmentId", params.segment), formData.append(csrfTokenKey, csrf.csrfTokenValue);
  ...
  return json13(await response.json());
}

// server-assets-manifest:@remix-run/dev/assets-manifest
var assets_manifest_default = { entry: { module: "/build/entry.client-MQ7UHQ6C.js", imports: ["/build/_shared/chunk-ZWGWGGVF.js", "/build/_shared/chunk-GIAAE3CH.js", "/build/_shared/chunk-K7KOCSKT.js", "/build/_shared/chunk-XU7DNSPJ.js", "/build/_shared/chunk-TIITO2TX.js", "/build/_shared/chunk-UWV35TSL.js", "/build/_shared/chunk-BOXFZXVX.js", "/build/_shared/chunk-PNG5AS42.js"] }, routes: { root: { id: "root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/root-7ZQ7HWTB.js", imports: ["/build/_shared/chunk-RPF4ZUUK.js", "/build/_shared/chunk-6LMWWETO.js", "/build/_shared/chunk-G7CHZRZX.js"], hasAction: !1, hasLoader: !0, hasErrorBoundary: !1 }, "routes/_auth+/login": { id: "routes/_auth+/login", parentId: "root", path: "login", index: void 0, caseSensitive: void 0, module: "/build/routes/_auth+/login-6WZEJBU3.js", imports: ["/build/_shared/chunk-D5L4Z6EH.js", "/build/_shared/chunk-JSCKBFOW.js", "/build/_shared/chunk-B3C6UAE7.js", "/build/_shared/chunk-FOFYP6DD.js"], hasAction: !0, hasLoader: !0, hasErrorBoundary: !1 }, "routes/_auth+/logout": { id: "routes/_auth+/logout", parentId: "root", path: "logout", index: void 0, caseSensitive: void 0, module: "/build/routes/_auth+/logout-M5ZJ3ZMG.js", imports: void 0, hasAction: !0, hasLoader: !0, hasErrorBoundary: !1 }, "routes/_index": { id: "routes/_index", parentId: "root", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/_index-U4RN25SL.js", imports: ["/build/_shared/chunk-B3C6UAE7.js", "/build/_shared/chunk-FOFYP6DD.js"], hasAction: !1, hasLoader: !1, hasErrorBoundary: !1 }, "routes/_single+/business": { id: "routes/_single+/business", parentId: "root", path: "business", index: void 0, caseSensitive: void 0, module: "/build/routes/_single+/business-NC4FQTRD.js", imports: ["/build/_shared/chunk-B3C6UAE7.js", "/build/_shared/chunk-FOFYP6DD.js"], hasAction: !1, hasLoader: !1, hasErrorBoundary: !1 }, "routes/_single+/contact-us": { id: "routes/_single+/contact-us", parentId: "root", path: "contact-us", index: void 0, caseSensitive: void 0, module: "/build/routes/_single+/contact-us-XZ4FVRLU.js", imports: ["/build/_shared/chunk-FOFYP6DD.js"], hasAction: !0, hasLoader: !1, hasErrorBoundary: !1 }, "routes/_single+/faq": { id: "routes/_single+/faq", parentId: "root", path: "faq", index: void 0, caseSensitive: void 0, module: "/build/routes/_single+/faq-KQWLMMIP.js", imports: ["/build/_shared/chunk-B3C6UAE7.js", "/build/_shared/chunk-FOFYP6DD.js"], hasAction: !1, hasLoader: !1, hasErrorBoundary: !1 }, "routes/_users+/my-account+/_index": { id: "routes/_users+/my-account+/_index", parentId: "routes/_users+/my-account", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/_users+/my-account+/_index-SBH6HMKB.js", imports: void 0, hasAction: !1, hasLoader: !1, hasErrorBoundary: !1 }, "routes/_users+/my-account+/certifications": { id: "routes/_users+/my-account+/certifications", parentId: "routes/_users+/my-account", path: "certifications", index: void 0, caseSensitive: void 0, module: "/build/routes/_users+/my-account+/certifications-GAQ4F3BN.js", imports: void 0, hasAction: !1, hasLoader: !1, hasErrorBoundary: !1 }, "routes/_users+/my-account+/edit": { id: "routes/_users+/my-account+/edit", parentId: "routes/_users+/my-account", path: "edit", index: void 0, caseSensitive: void 0, module: "/build/routes/_users+/my-account+/edit-KYVI5OB6.js", imports: void 0, hasAction: !1, hasLoader: !1, hasErrorBoundary: !1 }, "routes/_users+/my-account+/invoices": { id: "routes/_users+/my-account+/invoices", parentId: "routes/_users+/my-account", path: "invoices", index: void 0, caseSensitive: void 0, module: "/build/routes/_users+/my-account+/invoices-4SWXXQXI.js", imports: void 0, hasAction: !1, hasLoader: !1, hasErrorBoundary: !1 }, "routes/_users+/my-account+/password": { id: "routes/_users+/my-account+/password", parentId: "routes/_users+/my-account", path: "password", index: void 0, caseSensitive: void 0, module: "/build/routes/_users+/my-account+/password-ADDBZQE3.js", imports: void 0, hasAction: !1, hasLoader: !1, hasErrorBoundary: !1 }, "routes/_users+/my-account": { id: "routes/_users+/my-account", parentId: "root", path: "my-account", index: void 0, caseSensitive: void 0, module: "/build/routes/_users+/my-account-FKQUQG2F.js", imports: ["/build/_shared/chunk-JSCKBFOW.js", "/build/_shared/chunk-B3C6UAE7.js", "/build/_shared/chunk-FOFYP6DD.js"], hasAction: !1, hasLoader: !0, hasErrorBoundary: !1 }, "routes/_users+/my-courses": { id: "routes/_users+/my-courses", parentId: "root", path: "my-courses", index: void 0, caseSensitive: void 0, module: "/build/routes/_users+/my-courses-633UXZPR.js", imports: ["/build/_shared/chunk-3LIT6UNG.js", "/build/_shared/chunk-3GFW7QQ7.js", "/build/_shared/chunk-D5L4Z6EH.js", "/build/_shared/chunk-JSCKBFOW.js", "/build/_shared/chunk-B3C6UAE7.js", "/build/_shared/chunk-FOFYP6DD.js"], hasAction: !1, hasLoader: !0, hasErrorBoundary: !0 }, "routes/business-portal+/$course": { id: "routes/business-portal+/$course", parentId: "root", path: "business-portal/:course", index: void 0, caseSensitive: void 0, module: "/build/routes/business-portal+/$course-HH2DFDDP.js", imports: ["/build/_shared/chunk-DMNBMK5S.js", "/build/_shared/chunk-H2J5FYUN.js", "/build/_shared/chunk-JSCKBFOW.js", "/build/_shared/chunk-B3C6UAE7.js", "/build/_shared/chunk-FOFYP6DD.js"], hasAction: !1, hasLoader: !0, hasErrorBoundary: !1 }, "routes/business-portal+/_index": { id: "routes/business-portal+/_index", parentId: "root", path: "business-portal/", index: !0, caseSensitive: void 0, module: "/build/routes/business-portal+/_index-XDSAPUZL.js", imports: ["/build/_shared/chunk-DMNBMK5S.js", "/build/_shared/chunk-D5L4Z6EH.js", "/build/_shared/chunk-JSCKBFOW.js", "/build/_shared/chunk-B3C6UAE7.js", "/build/_shared/chunk-FOFYP6DD.js"], hasAction: !1, hasLoader: !0, hasErrorBoundary: !1 }, "routes/courses+/$course": { id: "routes/courses+/$course", parentId: "root", path: "courses/:course", index: void 0, caseSensitive: void 0, module: "/build/routes/courses+/$course-4YETQ4DI.js", imports: ["/build/_shared/chunk-3GFW7QQ7.js", "/build/_shared/chunk-H2J5FYUN.js", "/build/_shared/chunk-B3C6UAE7.js", "/build/_shared/chunk-FOFYP6DD.js"], hasAction: !1, hasLoader: !0, hasErrorBoundary: !1 }, "routes/courses+/$course_+/$lesson": { id: "routes/courses+/$course_+/$lesson", parentId: "root", path: "courses/:course/:lesson", index: void 0, caseSensitive: void 0, module: "/build/routes/courses+/$course_+/$lesson-CONJ434S.js", imports: ["/build/_shared/chunk-3GFW7QQ7.js", "/build/_shared/chunk-JSCKBFOW.js", "/build/_shared/chunk-B3C6UAE7.js", "/build/_shared/chunk-FOFYP6DD.js"], hasAction: !1, hasLoader: !0, hasErrorBoundary: !1 }, "routes/courses+/$course_+/$lesson_.$segment": { id: "routes/courses+/$course_+/$lesson_.$segment", parentId: "root", path: "courses/:course/:lesson/:segment", index: void 0, caseSensitive: void 0, module: "/build/routes/courses+/$course_+/$lesson_.$segment-EJ6FONNW.js", imports: ["/build/_shared/chunk-3GFW7QQ7.js", "/build/_shared/chunk-JSCKBFOW.js", "/build/_shared/chunk-B3C6UAE7.js", "/build/_shared/chunk-FOFYP6DD.js"], hasAction: !1, hasLoader: !0, hasErrorBoundary: !1 }, "routes/courses+/$course_+/$lesson_.$segment_.quiz_.$quiz": { id: "routes/courses+/$course_+/$lesson_.$segment_.quiz_.$quiz", parentId: "root", path: "courses/:course/:lesson/:segment/quiz/:quiz", index: void 0, caseSensitive: void 0, module: "/build/routes/courses+/$course_+/$lesson_.$segment_.quiz_.$quiz-4IPNO6MF.js", imports: ["/build/_shared/chunk-H2J5FYUN.js", "/build/_shared/chunk-B3C6UAE7.js", "/build/_shared/chunk-FOFYP6DD.js"], hasAction: !1, hasLoader: !1, hasErrorBoundary: !1 }, "routes/courses+/_index": { id: "routes/courses+/_index", parentId: "root", path: "courses/", index: !0, caseSensitive: void 0, module: "/build/routes/courses+/_index-ZUK3TL6Z.js", imports: ["/build/_shared/chunk-3LIT6UNG.js", "/build/_shared/chunk-3GFW7QQ7.js", "/build/_shared/chunk-B3C6UAE7.js", "/build/_shared/chunk-FOFYP6DD.js"], hasAction: !1, hasLoader: !0, hasErrorBoundary: !1 }, "routes/courses+/overview.$course": { id: "routes/courses+/overview.$course", parentId: "root", path: "courses/overview/:course", index: void 0, caseSensitive: void 0, module: "/build/routes/courses+/overview.$course-HPE2LZUN.js", imports: ["/build/_shared/chunk-3GFW7QQ7.js", "/build/_shared/chunk-H2J5FYUN.js", "/build/_shared/chunk-D5L4Z6EH.js", "/build/_shared/chunk-JSCKBFOW.js", "/build/_shared/chunk-B3C6UAE7.js", "/build/_shared/chunk-FOFYP6DD.js"], hasAction: !1, hasLoader: !0, hasErrorBoundary: !0 }, "routes/resources+/certificate": { id: "routes/resources+/certificate", parentId: "root", path: "resources/certificate", index: void 0, caseSensitive: void 0, module: "/build/routes/resources+/certificate-WNPKOTGO.js", imports: void 0, hasAction: !1, hasLoader: !0, hasErrorBoundary: !1 }, "routes/resources+/segment-status.$userCourse.$segment": { id: "routes/resources+/segment-status.$userCourse.$segment", parentId: "root", path: "resources/segment-status/:userCourse/:segment", index: void 0, caseSensitive: void 0, module: "/build/routes/resources+/segment-status.$userCourse.$segment-EAM6C2HA.js", imports: void 0, hasAction: !1, hasLoader: !0, hasErrorBoundary: !1 } }, version: "284dfd6a", hmr: { runtime: "/build/_shared/chunk-TIITO2TX.js", timestamp: 1702949550132 }, url: "/build/manifest-284DFD6A.js" };
